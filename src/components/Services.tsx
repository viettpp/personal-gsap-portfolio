      ...
      <div className="flex flex-col md:flex-row w-full gap-[3rem] lg:gap-[4rem] xl:gap-[15rem] 2xl:gap-[25rem]">
        <div className="core-services__left">
          <h1 className="title text-[3.75rem] md:text-[5.5rem] lg:text-[7.5rem] xl:text-[8rem] 2xl:text-[11rem] leading-[0.9] mb-4">
            Core<br />Exp<span className="kelsi text-[3.5rem] md:text-[5rem] lg:text-[7rem] xl:text-[7.5rem] 2xl:text-[10.5rem] relative -left-[0.10em] -mr-[0.20em]">e</span>rtise
          </h1>
        ...
        <div className="core-services__right pr-2 pb-[5rem] md:pb-0">
          <table className="services-table w-full">
            <tbody>
              {/* [MAKE] Category */}
              <tr>
                <td rowSpan={3} className="category-cell text-[0.688rem] xl:text-[0.75rem] 2xl:text-[1rem] w-[60px] xl:w-[100px] 2xl:w-[150px]">[MAKE]</td>
                <td className="number-cell text-[0.688rem] xl:text-[0.75rem] 2xl:text-[1rem] pl-0 w-[20px]" data-category="[MAKE]">
                ...
                <td className="item-cell text-[1.25rem] md:text-[1.375rem] lg:text-[1.625rem] xl:text-[1.75rem] 2xl:text-[2.375rem] pl-4 xl:pl-8 pt-1 pb-4">
                  ...
                  <div className="text-wrapper">Product Engineering</div>
                </td>
              </tr>
              <tr>
                ...
                <td className="item-cell text-[1.25rem] md:text-[1.375rem] lg:text-[1.625rem] xl:text-[1.75rem] 2xl:text-[2.375rem] pl-4 xl:pl-8 pt-5 pb-4 2xl:pt-7 2xl:pb-6">
                  <span className="top-line"></span>
                  <div className="text-wrapper">Applied AI</div>
                </td>
              </tr>
              <tr>
                <td className="number-cell text-[0.688rem] xl:text-[0.75rem] 2xl:text-[1rem] pl-0 pt-4">
                ...
                <td className="item-cell text-[1.25rem] md:text-[1.375rem] lg:text-[1.625rem] xl:text-[1.75rem] 2xl:text-[2.375rem] pl-4 xl:pl-8 pt-5 pb-4 2xl:pt-7 2xl:pb-6">
                  <span className="top-line"></span>
                  <div className="text-wrapper">Data Governance</div>
                </td>
              </tr>

              {/* [SHAPE] Category */}
              <tr>
                <td rowSpan={3} className="category-cell text-[0.688rem] xl:text-[0.75rem] 2xl:text-[1rem] pt-4">[SHAPE]</td>
                <td className="number-cell text-[0.688rem] xl:text-[0.75rem] 2xl:text-[1rem] pl-0 pt-4" data-category="[SHAPE]">
                  <div className="text-wrapper">04</div>
                </td>
                <td className="item-cell text-[1.25rem] md:text-[1.375rem] lg:text-[1.625rem] xl:text-[1.75rem] 2xl:text-[2.375rem] pl-4 xl:pl-8 pt-5 pb-4 2xl:pt-7 2xl:pb-6">
                  <span className="top-line"></span>
                  <div className="text-wrapper">Product Strategy</div>
                </td>
              </tr>
              <tr>
                <td className="number-cell text-[0.688rem] xl:text-[0.75rem] 2xl:text-[1rem] pl-0 pt-4">
                ...
                <td className="item-cell text-[1.25rem] md:text-[1.375rem] lg:text-[1.625rem] xl:text-[1.75rem] 2xl:text-[2.375rem] pl-4 xl:pl-8 pt-5 pb-4 2xl:pt-7 2xl:pb-6">
                  <span className="top-line"></span>
                  <div className="text-wrapper">Startup Strategy</div>
                </td>
              </tr>
              <tr>
                <td className="number-cell text-[0.688rem] xl:text-[0.75rem] 2xl:text-[1rem] pl-0 pt-4">
                ...
                <td className="item-cell text-[1.25rem] md:text-[1.375rem] lg:text-[1.625rem] xl:text-[1.75rem] 2xl:text-[2.375rem] pl-4 xl:pl-8 pt-5 pb-4 2xl:pt-7 2xl:pb-6">
                  <span className="top-line"></span>
                  <div className="text-wrapper">Team Leadership</div>
                </td>
              </tr>

              {/* [TELL] Category */}
              <tr>
                <td rowSpan={1} className="category-cell text-[0.688rem] xl:text-[0.75rem] 2xl:text-[1rem] pt-4">[TELL]</td>
                <td className="number-cell text-[0.688rem] xl:text-[0.75rem] 2xl:text-[1rem] pl-0 pt-4" data-category="[TELL]">
                  <div className="text-wrapper">07</div>
                </td>
                <td className="item-cell text-[1.25rem] md:text-[1.375rem] lg:text-[1.625rem] xl:text-[1.75rem] 2xl:text-[2.375rem] pl-4 xl:pl-8 pt-5 pb-4 2xl:pt-7 2xl:pb-6">
                  <span className="top-line"></span>
                  <div className="text-wrapper">Digital Storytelling</div>
                </td>
              </tr>
            </tbody>
          </table>
